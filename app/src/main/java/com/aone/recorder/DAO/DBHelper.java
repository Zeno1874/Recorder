...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String create_list_db_sql = "create table if not exists " + LIST_TABLE_NAME +" (id integer primary key, FileName text, FileFormat text, FilePath text, FileRecordLength int, FileCreatedTime int)";
