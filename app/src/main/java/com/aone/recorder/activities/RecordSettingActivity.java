...
public class RecordSettingActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private RelativeLayout rl_setting_audioSource_select,
                           rl_setting_outputFileFormat_select,
                           rl_setting_audioChannels_select,
                           rl_setting_audioSamplingRate_select;
    private TextView tv_setting_audioSource,
                     tv_setting_outputFileFormat,
                     tv_setting_audioChannels,
                     tv_setting_audioSamplingRate;
    private ImageView imgBtn_setting_audioSource,
                      imgBtn_setting_outputFileFormat,
                      imgBtn_setting_audioChannels,
                      imgBtn_setting_audioSamplingRate;
    private ListView lv_setting_audioSource,
                     lv_setting_outputFileFormat,
                     lv_setting_audioChannels,
                     lv_setting_audioSamplingRate;
    private boolean lv_setting_audioSource_state = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initConfig();
        // 选择框
        rl_setting_audioSource_select = findViewById(R.id.rl_setting_audioSource_select);
        ...
        rl_setting_audioSource_select.setOnClickListener(this);
        ...
        // TextView
        tv_setting_audioSource = findViewById(R.id.tv_setting_audioSource);
        ...
        tv_setting_audioSource.setText(dp_audioSource);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.imgBtn_setting2record:
                ...
                break;
            case R.id.rl_setting_audioSource_select:
                if (lv_setting_audioSource_state){
                    imgBtn_setting_audioSource.setImageResource(R.drawable.btn_arrow_down);
                    lv_setting_audioSource.setVisibility(View.VISIBLE);
                    // 设置适配器
                    lv_setting_audioSource.setAdapter(new SettingListViewAdapter(this, AudioSourceList));

                    lv_setting_audioSource.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        @Override
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            tv_setting_audioSource.setText(AudioSourceList.get(position));
                            String value = String.valueOf(RecordConfigUtil.encodeAudioSource(AudioSourceList.get(position)));
                            configDAO.updateConfig(RecordSettingActivity.this,"AudioSource", value);
                            imgBtn_setting_audioSource.setImageResource(R.drawable.btn_arrow_right);
                            lv_setting_audioSource.setVisibility(View.GONE);
                        }
                    });
                }else {
                    imgBtn_setting_audioSource.setImageResource(R.drawable.btn_arrow_right);
                ...
                lv_setting_audioSource_state = !lv_setting_audioSource_state;
                break;
                ...
                if (lv_setting_outputFileFormat_state){
                    ...
                    lv_setting_outputFileFormat.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            configDAO.updateConfig(RecordSettingActivity.this,"OutputFileFormat", value);
                ...
                if (lv_setting_audioChannels_state){
                    ...
                    lv_setting_audioChannels.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            configDAO.updateConfig(RecordSettingActivity.this,"AudioChannels", value);
                ...
                if (lv_setting_audioSamplingRate_state){
                    ...
                    lv_setting_audioSamplingRate.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            configDAO.updateConfig(RecordSettingActivity.this,"AudioSamplingRate", value);
    ...
    public void initConfig(){
        dp_audioSource = RecordConfigUtil.decodeAudioSource(mRecordConfig.getAudioSource());
